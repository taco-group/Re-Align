...
def eval_model(args):
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        ans_dict = {"model_prediction": outputs }
        ans_item = {**line, **ans_dict}
        ans_file.write(json.dumps(ans_item) + "\n")
        ans_file.flush()
    ans_file.close()

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--model-path", type=str, default="/home/xingshuo/vlm-alignment/output/test/llava-v1.6-alignment")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--image-folder", type=str, default="/home/xingshuo/vlm-alignment/dataset/scienceqa/test")
    parser.add_argument("--question-file", type=str, default="/home/xingshuo/vlm-alignment/dataset/scienceqa/llava_test_CQM-A.json")
    parser.add_argument("--answers-file", type=str, default="/home/xingshuo/vlm-alignment/dataset/scienceqa/answers/llava-v1.6-mistral-7b-answer.jsonl")
